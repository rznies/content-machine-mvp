...
export const ActivityPanel: React.FC = () => {
  ...
  // Keyboard shortcut listener: Cmd+. / Ctrl+. toggles panel
  useEffect(() => {
          ...
          >
            ...
            <div className="p-4 border-b border-zinc-800 flex items-center justify-between shrink-0 bg-zinc-900/50">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={clearLogs}
                  title="Clear history"
                  className="p-1.5 hover:text-rose-400 text-zinc-500 rounded-md transition-colors hover:bg-zinc-900"
                >
                  <Trash size={15} />
                </button>
                <button
                  onClick={() => setIsActivityOpen(false)}
                  className="p-1.5 hover:text-foreground text-zinc-500 rounded-md transition-colors hover:bg-zinc-900"
                >
                  <X size={15} />
                </button>
              </div>
                ...
                {sortedActivities.length === 0 ? (
                  ...
                  sortedActivities.map((act, idx) => (
                    ...
                    >
                      ...
                      <p className="text-xs text-zinc-300 leading-normal mt-2 select-text font-normal">
                        {act.action}
                      </p>
                      {act.stepLink && (
                        <button
                          ...
                          className="mt-2.5 inline-flex items-center gap-1 text-[10px] text-primary font-medium hover:underline hover:text-primary/80 transition-colors"
                        >
            ...
            <div className="p-3 border-t border-zinc-800 shrink-0 bg-zinc-900/50 flex justify-between items-center select-none">
              <button
                ...
                className={clsx(
                  "px-3 py-1 text-[10px] font-mono rounded-md border transition-all active:scale-[0.98]",
                  isAdvancedMode
